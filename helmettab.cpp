...
HelmetTab::HelmetTab(SaveManager* mgr, QWidget* parent, int sectionId)
    : ListTab(mgr, parent, sectionId)
    , form(new Ui::HelmetTabForm)
{
    ...
    foreach (const dataentry_t& it, GameData::getInstance().getData("helmet")) {
